    ...
    <View style={styles.screen}>
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>실제 전송 없이 시연용 완료 알림을 표시합니다</Text>
        </View>
                ...
                return (
                  ...
                  >
                    ...
                    <View style={{ flex: 1 }}>
                      ...
                      <Text style={styles.zoneSub}>{getDemoStatusLabel(zone.status)} · {zone.count}명</Text>
                    </View>
...
const styles = StyleSheet.create({
  ...
  zoneGrid: { gap: 10 },
  zoneChip: { minHeight: 72, borderRadius: 16, borderWidth: 1.3, borderColor: THEME.border, backgroundColor: THEME.white, flexDirection: 'row', alignItems: 'center', gap: 12, paddingHorizontal: 14 },
  zoneChipSelected: { borderColor: THEME.primary, backgroundColor: THEME.primaryLight },
  zoneDot: { width: 11, height: 11, borderRadius: 6 },
  zoneName: { color: THEME.dark, fontSize: 16, fontWeight: '900' },
  zoneSub: { color: THEME.muted, fontSize: 12, fontWeight: '700', marginTop: 3 },
  messageList: { gap: 14 },
