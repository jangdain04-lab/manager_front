...
const DEMO_ZONES: CrowdZone[] = [
  { id: '1', camera: 'cam 1', name: '도서관 앞', density: 61, riskLevel: 'warning', peopleCount: 11, gridPos: { x: 29, y: 42 } },
  { id: '2', camera: 'cam 2', name: '학생회관 앞', density: 11, riskLevel: 'relaxed', peopleCount: 2, gridPos: { x: 74, y: 42 } },
  { id: '3', camera: 'cam 3', name: '후생관 앞', density: 39, riskLevel: 'warning', peopleCount: 7, gridPos: { x: 35, y: 72 } },
  { id: '4', camera: 'cam 4', name: '공대 정류장', density: 17, riskLevel: 'relaxed', peopleCount: 3, gridPos: { x: 78, y: 72 } },
];
...
export const mockAlerts: Alert[] = [
  {
    ...
    message: '도서관 앞 주의 단계가 감지되었습니다. 학생회관 앞 방향으로 우회해 주세요.',
    read: false,
    pinned: true,
    progress: 66,
  },
  {
    ...
    message: '공대 정류장 위험 단계가 감지되었습니다. 정류장 접근을 잠시 피해주세요.',
    read: false,
    progress: 88,
  },
];
