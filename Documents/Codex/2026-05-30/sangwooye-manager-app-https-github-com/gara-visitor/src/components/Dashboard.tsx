...
import { DEMO_REFRESH_INTERVAL_MS, fetchPublicAnnouncements, fetchPublicMissingChildren } from '../services/api';
...
export function Dashboard({ navigation }: any) {
  ...
  useEffect(() => {
    ...
    loadDashboardData();
    const timer = setInterval(loadDashboardData, DEMO_REFRESH_INTERVAL_MS);
