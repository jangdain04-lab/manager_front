...
export const DEMO_PLACES = [
  { id: 'cam1', camera: 'cam 1', name: '도서관 앞', staff: 1 },
  { id: 'cam2', camera: 'cam 2', name: '학생회관 앞', staff: 3 },
  { id: 'cam3', camera: 'cam 3', name: '후생관 앞', staff: 2 },
  { id: 'cam4', camera: 'cam 4', name: '공대 정류장', staff: 2 },
] as const;
...
export function getDemoSecond() {
  return Math.floor(Date.now() / DEMO_REFRESH_INTERVAL_MS) % DEMO_DENSITY_ROWS.length;
}
