...
const DEFAULT_FESTIVAL_INFO: FestivalInfoData = {
  ...
  description: [
    'manager 앱과 같은 60초 데모 데이터를 기준으로 혼잡 상황이 표시됩니다.',
    '도서관 앞, 학생회관 앞, 후생관 앞, 공대 정류장 4개 구역의 현재 상태를 확인할 수 있습니다.',
    '위험 상황을 발견하면 빠른 신고 기능으로 운영요원에게 상황을 전달해 주세요.',
  ],
  contacts: [
  ...
  cautions: [
    '혼잡한 곳에서는 밀지 마세요.',
    '어린이는 보호자와 함께 이동하세요.',
    'manager 알림이 표시되면 안내된 우회 동선을 이용하세요.',
    '실시간처럼 반복되는 혼잡도를 확인하며 이동하세요.',
  ],
};
